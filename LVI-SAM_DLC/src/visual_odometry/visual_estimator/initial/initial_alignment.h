...
public:
    ...
    n(n_in)
    {
        ...
        q_lidar_to_cam = imu2LidarExtrinsicRot.inverse();
        q_lidar_to_cam_eigen = Eigen::Quaterniond(imu2LidarExtrinsicRot.inverse().w(), imu2LidarExtrinsicRot.inverse().x(), \
                                    imu2LidarExtrinsicRot.inverse().y(), imu2LidarExtrinsicRot.inverse().z());
